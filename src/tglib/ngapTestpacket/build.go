...
func BuildInitialContextSetupResponse(amfUeNgapID, ranUeNgapID int64, pduId int64, ipv4 string,
	...
	pDUSessionResourceSetupItemCxtRes.PDUSessionID.Value = pduId //THE ORIGINAL CODE HAS A 10 HERE
...
func BuildPDUSessionResourceSetupResponseForRegistrationTest(
	amfUeNgapID, ranUeNgapID int64, pduId int64, ipv4 string) (pdu ngapType.NGAPPDU) {
	...
	// PDU Session Resource Setup Response Item in PDU Session Resource Setup Response List
	pDUSessionResourceSetupItemSURes := ngapType.PDUSessionResourceSetupItemSURes{}
	pDUSessionResourceSetupItemSURes.PDUSessionID.Value = pduId //THE ORIGINAL CODE HAS A 10 HERE
...
func BuildPDUSessionResourceReleaseResponseForReleaseTest(amfUeNgapID, ranUeNgapID int64, pduId int64) (pdu ngapType.NGAPPDU) {
	...
	// PDU Session Resource Released Item
	pDUSessionResourceReleasedItemRelRes := ngapType.PDUSessionResourceReleasedItemRelRes{}
	pDUSessionResourceReleasedItemRelRes.PDUSessionID.Value = pduId //10
